...
<AppMeta
	title={`Hikes from ${year} - Page ${pagination.currentPage} | Personal Hike Experiences`}
	description={`Browse hiking blog posts from ${year} - Page ${pagination.currentPage}`}
	type="website"
/>
...
<section class="container mx-auto mb-8 min-h-[60vh]">
	<div class="mx-4 2xl:mx-0 md:px-24 mb-8">
		...
		<Heading tag="h2" class="mb-8">Hikes from {year} - Page {pagination.currentPage}</Heading>
		<div class="mt-8">
